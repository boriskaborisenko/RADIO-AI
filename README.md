...
2. **Интерактивный плейлист (Drawer)**:
   ...
   - Спроектировано стильное боковое меню в стиле **glassmorphism** (эффект матового стекла с размытием заднего фона).
...
1. **Извлечение текстов песен (Lyrics Extraction)**:
   - Исследование и реализация парсинга JSON-данных Suno AI для автоматического извлечения оригинального текста песен (слов) непосредственно из метаданных или API-ответов Suno.
2. **Отображение слов в реальном времени**:
   - Интеграция прокручиваемого блока слов песни в интерфейс веб-плеера, чтобы слова красиво скроллились во время прослушивания.
3. **Синхронный перевод песен**:
   - Реализация функции перевода текстов песен на лету на другие языки, позволяющая слушателю моментально понимать смысл исполняемой песни.
